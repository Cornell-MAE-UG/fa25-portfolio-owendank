...
![CAD model of torque wrench]({{ "/assets/images/3270-q1.png" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Model of Loads and boundary conditions]({{ "/assets/images/3270-q3.png" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Normal Strain Contours]({{ "/assets/images/3270-q4.png" | relative_url }}){: .inline-image-r style="width: 200px"}

5:

![Maximum Principal Stresses]({{ "/assets/images/3270-q5.png" | relative_url }}){: .inline-image-r style="width: 200px"}

6:

![FEM Calculations]({{ "/assets/images/3270-q6.png" | relative_url }}){: .inline-image-r style="width: 200px"}
...
![Torque Wrench Sensitivity]({{ "/assets/images/3270-q7.png" | relative_url }}){: .inline-image-r style="width: 200px"}
