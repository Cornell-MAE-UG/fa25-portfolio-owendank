...
![CAD model of torque wrench]({{ "/assets/images/3270-q1.png" | relative_url }}){: .inline-image-r style="width: 800px"}
...
![Model of Loads and boundary conditions]({{ "/assets/images/3270-q3.png" | relative_url }}){: .inline-image-r style="width: 800px"}
...
![Normal Strain Contours]({{ "/assets/images/3270-q4.png" | relative_url }}){: .inline-image-r style="width: 800px"}

5:

![Maximum Principal Stresses]({{ "/assets/images/3270-q5.png" | relative_url }}){: .inline-image-r style="width: 800px"}

6:

![FEM Calculations]({{ "/assets/images/3270-q6.png" | relative_url }}){: .inline-image-r style="width: 800px"}
...
![Torque Wrench Sensitivity]({{ "/assets/images/3270-q7.png" | relative_url }}){: .inline-image-r style="width: 800px"}
